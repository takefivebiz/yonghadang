...
Call log:
  - waiting for locator('button:has-text("다음")')
    - locator resolved to <button disabled class="flex-[2] rounded-xl py-3 text-sm font-medium text-white transition-colors active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50">다음</button>
...
- generic [ref=e1]:
  - generic [ref=e2]:
    - banner [ref=e3]:
      - generic [ref=e4]:
        - link "Corelog" [ref=e5] [cursor=pointer]:
          - /url: /
        - generic [ref=e6]:
          - button "메뉴 열기" [active] [ref=e7]:
            - img [ref=e8]
          - generic [ref=e10]:
            - generic [ref=e11]:
              - link "Corelog" [ref=e12] [cursor=pointer]:
                - /url: /
              - button "메뉴 닫기" [ref=e13]:
                - img [ref=e14]
            - navigation [ref=e17]:
              - link "비회원 리포트 조회" [ref=e18] [cursor=pointer]:
                - /url: /guest/lookup
    ...
    - main [ref=e20]:
      - generic [ref=e22]:
        - generic [ref=e24]:
          - generic [ref=e25]: 나를 읽는 중
          - generic [ref=e26]: 1/13
        - generic [ref=e29]:
          - heading "당신의 현재 연애 상황을 어떻게 설명하시겠어요?" [level=2] [ref=e31]
          - generic [ref=e32]:
            - button "현재 관계 중이에요" [ref=e33]
            - button "누군가를 좋아하는 중이에요" [ref=e34]
            - button "관계를 회피하는 중이에요" [ref=e35]
            - button "혼자 있는 게 편해요" [ref=e36]
          - generic [ref=e37]:
            - button "이전" [ref=e38]
            - button "다음" [disabled] [ref=e39]
    - contentinfo [ref=e40]:
      - generic [ref=e41]:
        - navigation [ref=e42]:
          - link "이용약관" [ref=e43] [cursor=pointer]:
            - /url: /terms
          - link "개인정보처리방침" [ref=e44] [cursor=pointer]:
            - /url: /privacy
          - link "문의하기" [ref=e45] [cursor=pointer]:
            - /url: /contact
        - generic [ref=e46]:
          - paragraph [ref=e47]: "상호명: 코어로그 | 대표자: 홍길동 | 사업자등록번호: 000-00-00000"
          - paragraph [ref=e48]: "주소: 서울특별시 강남구 테헤란로 000"
          - paragraph [ref=e49]: © 2026 Corelog. All rights reserved.
...
> 46  |         await nextBtn.click();
  ...
  139 |     });
  140 | 
  141 |     console.log('✅ Step 16: localStorage 상태 저장');
  142 |     console.log('=== 결제 전 상태 ===');
  143 |     console.log('sessionId:', sessionId);
  144 |     console.log('localStorage keys:', Object.keys(localStorage).filter(k => k.includes(sessionId)));
  145 | 
  146 |     // === Step 17: 결제 가능 여부 확인 ===
```