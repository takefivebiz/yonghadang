...
- [x] cn() 유틸리티 함수 작성
- [x] GitHub Public Repo 생성 및 초기 커밋 (`takefivebiz/yonghadang`)
...
# GitHub 원격 저장소 연동
git init
git remote add origin https://github.com/takefivebiz/yonghadang.git
...
- GitHub 레포: https://github.com/takefivebiz/yonghadang
