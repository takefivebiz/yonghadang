    ...
    scenes: [
      {
        ...
        role: "case_intake",
        goal: "사용자가 남긴 기록의 감정적 전제를 접수한다. 이 사람이 나를 좋아하는지에 대한 표면 질문보다, 사용자가 왜 확인을 필요로 하는 상태인지 조용히 잡는다.",
        focus: [
          "사용자가 지금 확인하려는 대상이 무엇인지",
          "애매한 관계 앞에서 생긴 감정적 긴장",
          "기록 초반부터 드러나는 모순, 불확실성, 흔들림",
          "사용자가 이 관계를 의뢰로 남기게 된 감정 상태",
        ],
        forbidden: [
          "사용자 입력을 다시 요약하지 않는다",
          "사용자의 성향을 단정하지 않는다",
      ...
      },
      {
        ...
        subtitle: "너는 여기서 \n 어떤 의미를 찾고 있을까?",
        role: "field_record",
        goal: "사용자의 기록에서 보이는 표면 상황과 반복되는 감정 반응을 정리한다. 상대의 마음을 판정하기보다, 사용자가 이 관계 안에서 어떤 의미를 계속 찾고 있는지 기록한다.",
        focus: [
          "사용자가 계속 확인하고 있는 신호",
          "상대 반응을 해석하는 방식",
          "반복해서 떠올리는 장면, 대화, 기대",
      ...
      },
      {
        ...
        subtitle: "상대는 왜 관계를\n 분명히 하지 않을까?",
        role: "clue_analysis",
        goal: "표면 기록 뒤에서 반복되는 감정 단서를 관찰자 시점으로 분석한다. 상대가 관계를 분명히 하지 않는 지점을 증명하려 하기보다, 그 애매함이 사용자에게 어떤 단서로 작동하는지 살핀다.",
        focus: [
          "반복되는 해석과 확인 욕구",
      ...
      },
      {
        ...
        goal: "이 관계가 왜 쉽게 정리되지 않는지, 감정 루프가 어떻게 작동하는지 추론한다. 사용자와 상대의 행동을 판정하지 않고, 현재 상황이 유지되는 구조를 보여준다.",
        focus: [
          "관계가 애매하게 유지되는 구조",
          "사용자가 붙잡고 있는 감정적 근거",
      ...
      },
      {
        ...
        role: "core_inference",
        goal: "리포트의 가장 밀도 높은 핵심 해석을 제시한다. 사용자가 표면적으로 묻는 질문 아래에 있는 진짜 확인 대상을 좁혀 잡는다.",
        focus: [
          "표면 질문 아래에 있는 숨은 질문",
          "사용자의 행동과 두려움이 만나는 지점",
          "끝까지 확인하고 싶어 하는 감정의 핵심",
          "관계보다 사용자의 기준이 흔들리는 지점",
        ],
        forbidden: [
          "앞선 관찰을 반복하지 않는다",
      ...
      },
      {
        ...
        subtitle: "이 관계는 결국 \n어디까지 이어질 수 있을까?",
        role: "final_report",
        goal: "정답을 내리지 않고, 이 기록에서 확인된 감정 흐름과 이후 관찰 지점을 정리한다. 관계가 어디까지 이어질지 예측하기보다, 이 관계가 사용자에게 남기는 방향성을 보고서처럼 닫는다.",
        focus: [
          "지금까지 드러난 감정 움직임",
          "이후에도 관찰해야 할 기준",
          "아직 해결되지는 않았지만 형태가 생긴 문제",
          "사용자가 다음에 확인해야 할 감정의 방향",
        ],
        forbidden: [
          "미래를 확정하지 않는다",
