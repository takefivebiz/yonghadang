...
const CATEGORY_TABS: {
...
}[] = [
  {
    value: "all",
    label: "전체",
    description: "당신에게 맞는 분석 방법을 찾아보세요",
  },
  {
    value: "mbti",
    label: "MBTI",
    description: "내 성격의 뿌리, 관계 패턴, 직업 적합성까지",
  },
  {
    value: "saju",
    label: "사주",
    description: "태어난 순간이 담고 있는 나만의 운명 코드",
  },
  {
    value: "tarot",
    label: "타로",
    description: "지금 이 순간, 가장 필요한 메시지를 카드가 전합니다",
  },
  {
    value: "astrology",
    label: "점성술",
    description: "별의 위치가 말해주는 당신의 본질과 가능성",
  },
];
...
export const ContentSection = () => {
  ...
  const activeCategoryDescription =
    CATEGORY_TABS.find((tab) => tab.value === activeCategory)?.description ??
    "";
  ...
  return (
    ...
    >
      ...
      <p
        key={activeCategory}
        className="mb-8 animate-fade-in text-center text-s text-muted-foreground"
      >
