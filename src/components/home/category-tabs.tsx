...
const CATEGORY_TAB_STYLE: Record<Category, string> = {
  ...
  relationship:
    "border-secondary/15 bg-secondary/6 text-secondary/65 hover:bg-secondary/10",
  career:
    "border-highlight/10 bg-highlight/4 text-highlight/55 hover:bg-highlight/8",
  emotion:
    "border-purple-400/15 bg-purple-400/6 text-purple-300/65 hover:bg-purple-400/10",
};
