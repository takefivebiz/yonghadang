...
const CategorySelectSheet = ({ isOpen, onClose }: CategorySelectSheetProps) => {
  ...
  return (
    <>
      ...
      {/* 바텀 시트 */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 max-h-[85vh] bg-gradient-to-t from-[rgba(20,20,38,0.98)] to-[rgba(28,28,50,0.96)] transition-transform duration-300 ${
