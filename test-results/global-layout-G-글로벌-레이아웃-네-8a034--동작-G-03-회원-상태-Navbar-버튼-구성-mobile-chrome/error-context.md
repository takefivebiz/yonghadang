...
- Name: global-layout.spec.ts >> G: 글로벌 레이아웃 / 네비게이션 >> G-01 ~ G-06: Navbar 렌더링 및 상태별 동작 >> G-03: 회원 상태 Navbar 버튼 구성
- Location: tests/e2e/global-layout.spec.ts:21:5
...
Locator: getByRole('link', { name: '마이페이지' })
Expected: visible
Timeout: 5000ms
