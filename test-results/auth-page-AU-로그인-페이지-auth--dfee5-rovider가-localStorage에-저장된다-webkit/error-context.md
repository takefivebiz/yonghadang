...
waiting for navigation until "load"
  navigated to "https://ecnoxnbiduwmgzpcfygc.supabase.co/auth/v1/authorize?provider=kakao&redirect_to=http%3A%2F%2Flocalhost%3A3000%2Fapi%2Fauth%2Fcallback%3Fnext%3D%252F&code_challenge=vb1429rf99q8afAKZETTSKxv5BRZYZtOj4QYBudhQuA&code_challenge_method=s256"
============================================================
```
