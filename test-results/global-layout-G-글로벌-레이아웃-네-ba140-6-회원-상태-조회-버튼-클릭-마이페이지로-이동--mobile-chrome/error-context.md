...
- Name: global-layout.spec.ts >> G: 글로벌 레이아웃 / 네비게이션 >> G-01 ~ G-06: Navbar 렌더링 및 상태별 동작 >> G-06: 회원 상태 "조회" 버튼 클릭 (마이페이지로 이동)
- Location: tests/e2e/global-layout.spec.ts:46:5
...
Call log:
  - waiting for getByRole('link', { name: '마이페이지' })
