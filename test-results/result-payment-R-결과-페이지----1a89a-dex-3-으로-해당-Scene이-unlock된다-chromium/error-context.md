...
- Name: result-payment.spec.ts >> R: 결과 페이지 - 결제 모달 >> R-25: URL 파라미터 결제 성공(single, sceneIndex=3)으로 해당 Scene이 unlock된다
- Location: tests/e2e/result-payment.spec.ts:187:3
