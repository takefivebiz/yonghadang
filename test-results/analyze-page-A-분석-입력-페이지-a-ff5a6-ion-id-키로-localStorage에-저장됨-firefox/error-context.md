...
- Name: analyze-page.spec.ts >> A: 분석 입력 페이지 (/analyze/[session_id]) >> A-25: 분석 데이터가 올바른 session_id 키로 localStorage에 저장됨
- Location: tests/e2e/analyze-page.spec.ts:284:3
