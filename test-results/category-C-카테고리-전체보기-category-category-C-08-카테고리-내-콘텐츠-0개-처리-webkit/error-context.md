...
- Name: category.spec.ts >> C: 카테고리 전체보기 (`/category/[category]`) >> C-08: 카테고리 내 콘텐츠 0개 처리
- Location: tests/e2e/category.spec.ts:78:3
...
Call log:
  - navigating to "http://localhost:3000/category/love", waiting until "load"
