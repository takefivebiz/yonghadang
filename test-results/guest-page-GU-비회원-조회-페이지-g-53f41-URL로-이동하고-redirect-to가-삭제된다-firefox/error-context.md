...
- Name: guest-page.spec.ts >> GU: 비회원 조회 페이지 (/guest) >> GU-18: sessionStorage에 redirect_to가 있을 때 세션 클릭 시 해당 URL로 이동하고 redirect_to가 삭제된다
- Location: tests/e2e/guest-page.spec.ts:256:3
