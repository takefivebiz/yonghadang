...
- Name: result-share.spec.ts >> R-30~34: 결과 페이지 공유 기능 (/result/[session_id]) >> R-32: X 공유 버튼 클릭 시 twitter intent URL에 shareUrl이 포함된다
- Location: tests/e2e/result-share.spec.ts:153:3
