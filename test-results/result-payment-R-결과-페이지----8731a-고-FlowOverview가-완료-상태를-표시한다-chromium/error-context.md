...
- Name: result-payment.spec.ts >> R: 결과 페이지 - 결제 모달 >> R-26: URL 파라미터 결제 성공(all)으로 모든 유료 Scene이 unlock되고 FlowOverview가 완료 상태를 표시한다
- Location: tests/e2e/result-payment.spec.ts:218:3
