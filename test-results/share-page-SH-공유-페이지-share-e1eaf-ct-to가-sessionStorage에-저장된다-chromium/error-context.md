...
- Name: share-page.spec.ts >> SH: 공유 페이지 (/share/[share_id]) >> SH-11: '비회원 조회하기' 클릭 시 /guest로 이동하고 redirect_to가 sessionStorage에 저장된다
- Location: tests/e2e/share-page.spec.ts:201:3
