...
- Name: result-share.spec.ts >> R-30~34: 결과 페이지 공유 기능 (/result/[session_id]) >> R-33: 카카오 공유 버튼 클릭 시 /share/[share_id] URL로 처리된다
- Location: tests/e2e/result-share.spec.ts:198:3
