...
- Name: result-payment.spec.ts >> R: 결과 페이지 - 결제 모달 >> R-29: 개별 Scene 구매 후 전체 구매 모달은 2,900원을 그대로 표시한다 (차액 결제 미지원 현재 구현 기준)
- Location: tests/e2e/result-payment.spec.ts:315:3
