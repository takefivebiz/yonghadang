...
- Name: result-payment.spec.ts >> R: 결과 페이지 - 결제 모달 >> R-28: unlock된 유료 Scene은 전체 콘텐츠가 표시되고 CTA 버튼이 없으며 'unlocked' 배지가 나타난다
- Location: tests/e2e/result-payment.spec.ts:290:3
