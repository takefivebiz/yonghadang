...
- Name: share-page.spec.ts >> SH: 공유 페이지 (/share/[share_id]) >> SH-02: localStorage 데이터 없으면 에러 메시지가 표시된다
- Location: tests/e2e/share-page.spec.ts:53:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/share/nonexistent-share-id-9999
Call log:
  - navigating to "http://localhost:3000/share/nonexistent-share-id-9999", waiting until "load"
