...
- Name: category.spec.ts >> C: 카테고리 전체보기 (`/category/[category]`) >> C-01 ~ C-04: 유효한 카테고리 접근 >> C-02: 유효한 카테고리('relationship') 접근
...
Call log:
  - navigating to "http://localhost:3000/category/relationship", waiting until "load"
