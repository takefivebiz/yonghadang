...
- Name: result-page.spec.ts >> R: 결과 페이지 (/result/[session_id]) >> R-16: FlowOverview에서 무료 씬은 unlocked 아이콘, 유료 씬은 locked 아이콘이 표시된다
- Location: tests/e2e/result-page.spec.ts:272:3
