...
- Name: content-page.spec.ts >> I: 콘텐츠 진입 (`/content/[id]`) >> I-03: 존재하지 않는 콘텐츠 ID 접근
- Location: tests/e2e/content-page.spec.ts:39:3
...
Call log:
  - navigating to "http://localhost:3000/content/invalid-content-id-99999", waiting until "load"
