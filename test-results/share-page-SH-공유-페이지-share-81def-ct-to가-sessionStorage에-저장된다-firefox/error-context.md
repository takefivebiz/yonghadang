...
- Name: share-page.spec.ts >> SH: 공유 페이지 (/share/[share_id]) >> SH-10: '로그인 하기' 클릭 시 /auth로 이동하고 redirect_to가 sessionStorage에 저장된다
- Location: tests/e2e/share-page.spec.ts:178:3
