...
- Name: result-share.spec.ts >> R-30~34: 결과 페이지 공유 기능 (/result/[session_id]) >> R-31: 링크 복사 버튼 클릭 시 shareUrl이 클립보드에 복사되고 toast가 표시된다
- Location: tests/e2e/result-share.spec.ts:110:3
